...
then
  ...
  then
    ...
    echo -e "${green}***************************************SUCCESSFULLY INSTALLED********************************************${endColor}"
    echo -e "${green}*********************************************************************************************************${endColor}"
    sleep 3
  else
    echo -e "${blue}*********************************************************************************************************${endColor}"
...
then
  echo ''
  echo -e "${endColor}*********************************************************************************************************${endColor}"
  echo -e "${endColor}************************************NO PACKAGE NEEDS TO UPDATE*******************************************${endColor}" 
  echo -e "${endColor}*********************************************************************************************************${endColor}"
  sleep 3
else
  echo -e "${green}*********************************************************************************************************${endColor}"
  ...
  do
    ...
    echo -e "${green}***********************************************************************************************************${endColor}"
    echo -e "${green}******************************THE PACKAGE WAS SUCCESSFULLY UPDATED*****************************************${endColor}"
    echo -e "${green}***********************************************************************************************************${endColor}"
done
